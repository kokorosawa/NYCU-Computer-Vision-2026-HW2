...
DEFAULT_MODEL_NAME = "SenseTime/deformable-detr"


def create_processor(model_name: str = DEFAULT_MODEL_NAME) -> DeformableDetrImageProcessor:
...
def create_model(
    ...
    config = DeformableDetrConfig.from_pretrained(model_name)
